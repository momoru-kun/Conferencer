...
from api.views import Register, CheckUsername, GetConferenceMembers, ChangeStatus, DeleteConference, GetConfirence, AddMember, GetUser, AllConfirence, InsertConference

...
from api.views import GetConferenceMembersExcel, GetConferencesExcel, SetApproval, GetAllMembers, Register, CheckUsername,GetConferenceMembers, ChangeStatus, DeleteConference, GetConfirence, AddMember, GetUser, AllConfirence, InsertConference
...
urlpatterns = [
    ...
    path('member.byConference', GetAllMembers.as_view()),
